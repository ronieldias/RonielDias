...
namespace RonielDias.Controllers
{
    public class PagamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DataLimite,Valor,Pagou")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataLimite,Valor,Pagou")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
