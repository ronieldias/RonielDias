...
dotnet-aspnet-codegenerator controller -name NotasDeVendasController -m NotaVenda -dc MyDbContext --relativeFolderPath Controllers --useDefaultLayout --referenceScriptLibraries
...
dotnet-aspnet-codegenerator controller -name TiposPagamentosController -m TipoPagamento -dc MyDbContext --relativeFolderPath Controllers --useDefaultLayout --referenceScriptLibraries
